...
namespace vsix.helpers
{
    ...
    {
        static DTE2 _dte = vsixsamplePackage._dte;
        ...
        {
            return (IComponentModel)vsixsamplePackage.GetGlobalService(typeof(SComponentModel));
        }
        ...
        public static int WriteFile(Project project, string file)
        {
            string extension = Path.GetExtension(file);


             WriteToDisk(file, string.Empty);

            return 0;
        }
        public static int CopyTmpToProjectFile(Project project, string file, string fileprojpath)
        {
            File.Copy(file, fileprojpath,true);
            

            return 0;
        }

        public static void WriteToDisk(string file, string content)
        {
